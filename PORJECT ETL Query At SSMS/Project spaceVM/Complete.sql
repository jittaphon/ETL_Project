...
SELECT 
    ...
    convert_disk,
    avg_convert_spec,
	avg_convert_spec -  isnull(SUM(avg_cs_ref),0) AS avg_convert_spec_change,
    SUM(avg_cs_ref) AS total_avg_cs_ref,
    String_AGG(cs_ref_no,',') AS cs_ref_no
FROM 
    JOIN_QT_TABLE
WHERE  cs_number IN ('CS-202205033415', 'CS-202110013475', 'CS-202205032167')
GROUP BY 
    cs_number,
    qt_number,
    real_cpu,
